...
- (void)loadBindingsIntoCustomControls
{
    ...
    if ([unit isEqualToString:@"lb"]) {
        ...
        else{firstComponentValueIsFour=FALSE;}
        useMetricUnits=TRUE;
...
- (void)commitChanges
{
    ...
    NSLog(@"weight is %i",weight);
    NSLog(@"weight Units are %@",unit);
...
//        NSInteger weightInteger;
        ...
        firstComponentInteger=firstComponentFloat ; 
        secondComponentFloat=(weight/10.0)-(firstComponentInteger*100);
