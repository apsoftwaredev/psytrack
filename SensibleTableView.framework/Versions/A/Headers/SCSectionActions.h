...
typedef void(^SCDidFetchItemsAction_Block)(SCArrayOfItemsSection *itemsSection, NSMutableArray *items);
...
@property (nonatomic, copy) SCDidFetchItemsAction_Block didFetchItemsFromStore;
