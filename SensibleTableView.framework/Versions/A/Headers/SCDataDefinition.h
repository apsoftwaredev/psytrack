...
/**	
 ...
 @warning *Important* This is an abstract base class and should never be directly instantiated.
 
 @see SCClassDefinition, SCEntityDefinition, SCDictionaryDefinition
 */
...
/** The set of cell action blocks that will be assigned to all cells generated by the definition's properties.
 ...
 @warning Note: Any action defined in the property definitions will automatically override its equivalent global action.
 */
 ...
 *  @warning Note: The order of the properties automatically added to this group is the same as their order in the data structure definition.
...
/** Returns the title string value for the given object. 
 ...
 @warning Note: object must be an instance of the data structure defined by the class. 
 */
 ...
 *
 *  @warning *Note* Must be implemented by subclasses.
 */
