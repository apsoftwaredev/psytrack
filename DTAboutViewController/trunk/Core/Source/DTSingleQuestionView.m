...
- (id)init
{
    ...
    if (self = [super init]) 
	{
		UIImage *upImage = [UIImage imageNamed:@"DTAboutViewController.bundle/UIButtonBarArrowUpSmall.png"];
		UIImage *downImage = [UIImage imageNamed:@"DTAboutViewController.bundle/UIButtonBarArrowDownSmall.png"];
