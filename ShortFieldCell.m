...
- (NSString *)titleForRow:(NSInteger)row
{
    ...
    switch (row) 
    {
        ...
        case 4: title = @"Mrs.";    break;
        case 5: title = @"Master";        break;
        case 6: title = @"Rev.";     break;
        case 7: title = @"Fr.";     break;
        case 8: title = @"Atty.";     break;
        case 9: title = @"Prof.";    break;
        case 10: title = @"Hon.";   break;
        case 11: title = @"Pres.";        break;
        case 12: title = @"Gov.";     break;
        case 13: title = @"Coach";     break;
        case 14: title = @"Ofc.";     break;
        case 15: title = @"Msgr.";     break;
        case 16: title = @"Sr.";     break;
        case 17: title = @"Br.";    break;
        case 18: title = @"Supt.";   break;
        case 19: title = @"Rep.";        break;
        case 20: title = @"Sen.";     break;
        case 21: title = @"Amb.";     break;
        case 22: title = @"Treas.";     break;

        case 23: title = @"Sec.";     break;
        case 24: title = @"Pvt.";     break;
        case 25: title = @"Spc.";    break;
        case 26: title = @"Sgt";   break;
        case 27: title = @"Adm";        break;
        case 28: title = @"Maj.";     break;
        case 29: title = @"Capt.";     break;
        case 30: title = @"Cmdr.";     break;
       
        case 31: title = @"Lt.";     break;
        case 32: title = @"Lt Col.";     break;
        case 33: title = @"Col.";    break;
