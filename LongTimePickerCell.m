...
- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component
{
    ...
    if (component==2) {
        switch (row) {
            case 0: returnStr=@"seconds"; break;
            case 1: returnStr=@"minutes"; break;
            case 2: returnStr=@"hours"; break;
            case 3: returnStr=@"days"; break;
            case 4: returnStr=@"weeks"; break;
            case 5: returnStr=@"months"; break;
            case 6: returnStr=@"years"; break;
            case 7: returnStr=@"decades"; break;
            case 8: returnStr=@"century"; break;
