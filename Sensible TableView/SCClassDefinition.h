 ...
 *
 *  @warning The type of uiElementClass must be a subclass of the standard UI generated by the property's type, otherwise it will be ignored. */
...
/**	
 ...
 'SCCustomPropertyDefinition' does not have to represent a property that actually exists in its class (unlike an SCPropertyDefiniton), and is often used in a class definition as a placeholder for custom user interface element generation.
