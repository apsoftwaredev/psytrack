...
@interface SCTableViewModel : NSObject <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
{
	...
	UITableView *__weak modeledTableView;
...
@property (nonatomic, SC_WEAK, readonly) SCTableViewCell *previousActiveCell;
...
@property (weak, nonatomic, readonly) NSIndexPath *activeCellIndexPath;
...
/** 
 Asks the dataSource to provide a custom navigation controller for the specified cell. The returned custom navigation controller will be used to push the automatically generated cell detail view, instead of using the default navigation controller hosting the cell's table view.
 *
 *	@param tableViewModel The model requesting the custom detail view controller.
 *	@param indexPath The index path of the cell whose detail view controller is requested. 
 *	@return The custom navigation view controller.
 */
- (UINavigationController *)tableViewModel:(SCTableViewModel *)tableViewModel
   customNavigationControllerForRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 *
 *	@param tableViewModel The model requesting the section header titles.
 *	@return An array of NSString section titles.
 */
- (NSArray *)tableViewModelSectionHeaderTitles:(SCArrayOfItemsModel *)tableViewModel;
...
/** 
 Notifies the delegate that the detail model for the section at the specified index has been configured with the appropriate sections and cells. This is the perfect time to do any customizations to the section's detail table view model after the automatically generated sections have been added.
 *	
 *	@param tableViewModel The model informing the delegate of the event.
 *	@param index The index of the section whose detail model has been configured.
 *	@param detailTableViewModel The model for the section's detail view.
 */
- (void)tableViewModel:(SCTableViewModel *)tableViewModel
    detailModelConfiguredForSectionAtIndex:(NSUInteger)index
  detailTableViewModel:(SCTableViewModel *)detailTableViewModel;
...
/** Notifies the delegate that the detail view for the section at the specified index did appear. 
 *	
 *	@param tableViewModel The model informing the delegate of the event.
 *	@param index The index of the section whose detail view did appear.
 *	@param detailTableViewModel The model for the section's detail view.
 */
- (void)tableViewModel:(SCTableViewModel *)tableViewModel
    detailViewDidAppearForSectionAtIndex:(NSUInteger)index
    withDetailTableViewModel:(SCTableViewModel *)detailTableViewModel;

/** Asks the delegate if the detail view for the section at the specified index should be dismissed.
 *	@param tableViewModel The model informing the delegate of the event.
...
- (BOOL)tableViewModel:(SCTableViewModel *)tableViewModel
    shouldDismissDetailViewForSectionAtIndex:(NSUInteger)index
    withDetailTableViewModel:(SCTableViewModel *)detailTableViewModel
 ...
 *
 *	@param tableViewModel The model requesting this information.
 ...
 */
- (NSIndexPath *)tableViewModel:(SCTableViewModel *)tableViewModel targetIndexPathForMoveFromRowAtIndexPath:(NSIndexPath *)sourceIndexPath toProposedIndexPath:(NSIndexPath *)proposedDestinationIndexPath;

/** 
 Asks the delegate if editing should begin for the text view of the cell at the specified indexPath.
 *	
 *	@param tableViewModel The model asking the delegate.
 *	@param indexPath The index path of the cell containing the text field.
 *  @param textView The text view.
 */
- (BOOL)tableViewModel:(SCTableViewModel *)tableViewModel rowAtIndexPath:(NSIndexPath *)indexPath textViewShouldBeginEditing:(UITextView *)textView;
 ...
 */
- (BOOL)tableViewModel:(SCTableViewModel *)tableViewModel rowAtIndexPath:(NSIndexPath *)indexPath textFieldShouldBeginEditing:(UITextField *)textField;
...
/** 
 Notifies the delegate that the detail view for the cell at the specified indexPath did appear.
 *	
 *	@param tableViewModel The model informing the delegate of the event.
 ...
 */
- (void)tableViewModel:(SCTableViewModel *)tableViewModel
    detailViewDidAppearForRowAtIndexPath:(NSIndexPath *)indexPath
    withDetailTableViewModel:(SCTableViewModel *)detailTableViewModel;
...
@interface SCArrayOfItemsModel : SCTableViewModel <SCTableViewControllerDelegate, UISearchBarDelegate>
{
    ...
    BOOL useSCObjectsSelectionSection;
}
...
/** Default Section Generated*/
@property (nonatomic, readwrite)BOOL useSCObjectsSelectionSection;
 ...
 *	@param _viewController The UIViewController to be bound to the model. _viewController must be the view controller that contains the modeledTableView.
 *	@param classDefinition The class definition of the entity of the objects.
 *  @param _useSCSelectionSection is bound to the model
 */
- (id)initWithTableView:(UITableView *)_modeledTableView
     withViewController:(UIViewController *)_viewController
withEntityClassDefinition:(SCClassDefinition *)classDefinition useSCSelectionSection:(BOOL)_useSCSelectionSection;
...
{	
    ...
    NSObject *__unsafe_unretained boundObject;
...
/** 
 ...
 using either the bound property value or the key value, respectively.
 */
@property (weak, nonatomic, readonly) NSMutableSet *selectedItemsIndexes;
